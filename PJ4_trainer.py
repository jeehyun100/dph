...
def main(model_path=None):
    ...
    # # Define the directory path of training and test datasets.
    train_path = './baby_train.txt'
    test_path = './baby_test.txt'
    data_path = '/shared_data/p_data/ai_challenge/speech_interface/proj3/donateacry-corpus/donateacry_corpus_cleaned_and_updated_data'
